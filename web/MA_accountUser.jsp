                ...
                <c:if test="${list==null}">
                    <div class="row mb-12">
                        <h2 class="col-12 tm-text-primary" style="text-align: center">
                            There Are No Account Available.
                        </h2>
                    </div>
                </c:if >            
                <c:if test="${list!=null}">
                        ...
                        <div class="table" style="padding: 0px 30px 0px 30px;">
                            ...
                            <div class="header_fixed">
                                <table >
                                    <thead>
                                        <tr>
                                            <th style="max-width: 50px; text-align: center">Account ID</th>
                                            <th style="text-align: center">Username</th>
                                            <th style="text-align: center">Password</th>
                                            <th style="text-align: center">Email</th>
                                            <th style="max-width: 100px; text-align: center">
                                                Grant Permission
                                            <a href="#"><button><i class="fa-regular fa-square-plus"></i></button></a>-->
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${accountUser}" var="ACU">
                                            <tr style="border: 1px solid black;" >
                                                <td style="text-align: center;">${ACU.getIDA()}</td>                                        
                                                <td style="text-align: center;">${ACU.getUSN()}</td>
                                                <td style="text-align: center;">${ACU.getUSP()}</td>
                                                <td style="text-align: center;">${ACU.getUSM()}</td>
                                                <td style="text-align: center;">
                                                    <a href="#?IDA=${ACU.getIDA()}"><i style="width: 50px;" class="fa-regular fa-square-plus fa-2x"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
