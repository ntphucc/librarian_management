...
<html lang="en">
    ...
    <body>
        ...
        <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/background.jpg">
            ...
            <form class="d-flex tm-search-form" action="SearchBorow">
                                ...
                                <table >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="max-width: 100px; text-align: center">Confirm</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${borrowOrder}" var="bo">
                                            <tr>
                                                <td style="text-align: center;">${bo.getIDO()}</td>                                        
                                                <td style="text-align: center;">${bo.getUSN()}</td>
                                                <td style="text-align: center;"><image src="${bo.getImg()}"></td>
                                                <td style="text-align: center;">${bo.getName()}</td>
                                                <td style="text-align: center;">${bo.getDate()}</td>
                                                <td style="text-align: center;">
                                                    <a href="MO_Accept_C?IDO=${bo.getIDO()}"><i class="fa-sharp fa-solid fa-circle-check fa-2x"></i></a>
                                                    <a href="MO_Reject_C?IDO=${bo.getIDO()}"><i style="width: 50px;" class="fa-sharp fa-solid fa-circle-xmark fa-2x"></i></a>
