...
<html lang="en">
    ...
    <body>
        ...
        <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/background.jpg">
            ...
            <form class="d-flex tm-search-form" action="SearchComplete">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="max-width: 150px; text-align: center">Date return</th>
                                            <th style="text-align: center">LIB Get Book</th>

                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${completedOrder}" var="co">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">${co.getDate_return()}</td>
                                                <td style="text-align: center;">${co.getLIB_Get()}</td>
